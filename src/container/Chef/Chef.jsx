    ...
    <div className="app__wrapper_info">
      ...
      <div className="app__chef-content">
        <div className="app__chef-content_quote">
          ...
          <p className="p__opensans" style={{ color: '#FFFFFF' }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit auctor sit .</p>
        </div>
      ...
      <div className="app__chef-sign">
        <p>Kevin Luo</p>
        <p className="p__opensans" style={{ color: '#FFFFFF' }}>Chef & Founder</p>
